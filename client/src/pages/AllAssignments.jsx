...
export default function AllAssignments() {
  ...
  useEffect(() => {
    ...
    if (course) {
      setSelectedClassroomId(course.classroom?._id || course.classroom);
    }
        ...
        {courses.length === 0 ? (
          <div className="text-center py-8">
            <div className="text-gray-500 mb-4">
              ...
              <p className="text-sm">You need to be enrolled in courses to view assignments.</p>
            </div>
          </div>
        ) : (
          <>
            ...
            {selectedCourseId && selectedClassroomId ? (
              <AssignmentSection courseId={selectedCourseId} classroomId={selectedClassroomId} />
            ) : (
